...
const Hint = ()=>{
	...
	<div className="hint__board">
		...
		<div className="hint__row">
			...
			<div className="hint__column2"><i>italics</i></div>
		</div>
		<Divider mg="1rem" />
		<div className="hint__row">
			<div className="hint__column">**bold**</div>
			<div className="hint__column2"><strong>Bold</strong></div>
		</div>
		<Divider mg="1rem" />
		<div className="hint__row">
		...
		<Divider mg="1rem" />
		<div className="hint__row">
			<div className="hint__column">* item 1 <br />
* item 2</div>
			<div className="hint__column2"><ul>
				<li>item 1</li>
				<li>item 2</li>
			</ul>
	</div>
		...
		<Divider mg="1rem" />
		<div className="hint__row">
			<div className="hint__column">1. item 1 <br />2. item 2</div>
			<div className="hint__column2">1. item 1 <br />2. item 2
	</div>
		</div>
		<Divider mg="1rem" />
		<div className="hint__row">
		...
		<div className="hint__row">
			<div className="hint__column">```<br />code block<br />```</div>
