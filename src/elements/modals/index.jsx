			...
			<Modal show={show} onHide={close}>
				...
				<Modal.Body>
					<Text type="p" bold mg="0" layer={2}>
						...
						elit. At commodi saepe excepturi iste et, qui,
						blanditiis praesentium minima dolores obcaecati dolorem.
						Eius quaerat laboriosam, sunt adipisci vitae libero vero
						minima.
					</Text>
				</Modal.Body>
				<Modal.Footer>
